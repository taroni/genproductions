...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-01946-fragment.py --fileout file:HIG-RunIISummer15wmLHEGS-01946.root --mc --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v8 --beamspot Realistic50ns13TeVCollision --era Run2_25ns --step LHE,GEN,SIM --magField 38T_PostLS1 --python_filename HIG-RunIISummer15wmLHEGS-01946_1_cfg.py --no_exec -n 10000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-01946-fragment.py nevts:10000'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('file:HIG-RunIISummer15wmLHEGS-01946_inLHE.root'),
